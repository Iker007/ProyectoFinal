	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		try {
			...
			statement.executeUpdate("CREATE TABLE TIPOS(" + 
					"NOMBRE_T VARCHAR(20) NOT NULL," + 
					"PRIMARY KEY(NOMBRE_T))");
			statement.executeUpdate("CREATE TABLE MOVIMIENTOS(" + 
					"NOMBRE_M VARCHAR(20) NOT NULL," + 
					"TIPO VARCHAR(20) NOT NULL," + 
					"DAMAGE INT (4) DEFAULT NULL," + 
					"EFECTO VARCHAR(20) DEFAULT NULL," + 
					"PRIMARY KEY(NOMBRE_M)," + 
					"FOREIGN KEY(TIPO) REFERENCES TIPOS(NOMBRE_T));");
			...
			statement.executeUpdate("CREATE TABLE ENTRENADOR(" + 
					"USUARIO VARCHAR(20) NOT NULL," + 
					"CONTRASEÑA VARCHAR(20) NOT NULL," + 
					"SCORE INT(4) DEFAULT 0," + 
					"POKEMON1 INT(3) NOT NULL," + 
					"POKEMON2 INT(3) NOT NULL," + 
					"POKEMON3 INT(3) NOT NULL," + 
					"POKEMON4 INT(3) NOT NULL," + 
					"POKEMON5 INT(3) NOT NULL," + 
					"POKEMON6 INT(3) NOT NULL," + 
					"PRIMARY KEY(USUARIO)," + 
			...
			res = statement.executeUpdate("INSERT INTO MOVIMIENTOS VALUES('PSYCHOATTACK', 'PSYCHYC', 140, 'ATAQUE / 2');");
			res = statement.executeUpdate("INSERT INTO MOVIMIENTOS VALUES('PROTECT', 'NORMAL', NULL, 'NEXT DMG = 0');");
			res = statement.executeUpdate("INSERT INTO MOVIMIENTOS VALUES('DISTORSION', 'DRAGON', 150, 'NEXT TURN NULL');");
			...
			res = statement.executeUpdate("INSERT INTO MOVIMIENTOS VALUES('SHADOW FORCE', 'GHOST', 150, 'NEXT TURN NULL');");
			...
			res = statement.executeUpdate("INSERT INTO MOVIMIENTOS VALUES('DRACO METEOR', 'DRAGON', 140, 'ATAQUE / 2');");
			...
			res = statement.executeUpdate("INSERT INTO MOVIMIENTOS VALUES('SWORDS DANCE', 'NORMAL', NULL, 'ATAQUE * 2');");
			...
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(0, 'ARCEUS', 'NORMAL', NULL, 100, 100, 500, 100, 'JUDGEMENT', 'RECOVER');");
			//System.out.println( res );
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(1, 'CRESSELIA', 'PSYCHYC', NULL, 50, 200, 600, 50, 'PSYCHYC', 'MOONLIGHT');");
			//System.out.println( res );
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(2, 'DARKRAI', 'DARK', NULL, 200, 50, 350, 200, 'NASTY PLOT', 'DARK PULSE');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(3, 'DEOXIS', 'PSYCHYC', NULL, 250, 20, 350, 250, 'PSYCHOATTACK', 'PROTECT');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(4, 'DIALGA', 'DRAGON', 'STEEL', 100, 150, 500, 50, 'DISTORSION', 'FLASH CANNON');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(5, 'GIRATINA', 'DRAGON', 'GHOST', 80, 120, 600, 70, 'DRAGON PULSE', 'SHADOW FORCE');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(6, 'HEATRAN', 'STEEL', 'FIRE', 150, 150, 500, 60, 'LAVA PLUME', 'EXPLOSION');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(7, 'HO-OH', 'FIRE', 'FLYING', 120, 120, 500, 90, 'SACRED FIRE', 'ROOST');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(8, 'LATIAS', 'DRAGON', 'PSYCHYC', 130, 70, 400, 250, 'MIST BALL', 'DRACO METEOR');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(9, 'LATIOS', 'DRAGON', 'PSYCHYC', 130, 70, 400, 250, 'LUSTER PURGE', 'DRACO METEOR');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(10, 'LUGIA', 'PSYCHYC', 'FLYING', 80, 150, 600, 80, 'AEROBLAST', 'ROOST');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(11, 'MEW', 'PSYCHYC', NULL, 70, 150, 500, 100, 'PSYCHYC', 'NASTY PLOT');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(12, 'PALKIA', 'DRAGON', 'WATER', 130, 100, 500, 65, 'HYDRO PUMP', 'SPACIAL REND');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(13, 'REGIGIGAS', 'NORMAL', NULL, 100, 200, 800, 20, 'SWORDS DANCE', 'RETURN');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(14, 'PIKACHU', 'ELECTRIC', NULL, 160, 75, 400, 300, 'SWORDS DANCE', 'RETURN');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(15, 'VENUSAUR', 'GRASS', 'POISON', 80, 200, 700, 40, 'SWORDS DANCE', 'RETURN');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(16, 'CHARIZARD', 'FIRE', 'FLYING', 130, 80, 500, 90, 'SWORDS DANCE', 'RETURN');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(17, 'BLASTOISE', 'WATER', NULL, 70, 250, 750, 10, 'SWORDS DANCE', 'RETURN');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(18, 'SNORLAX', 'NORMAL', NULL, 100, 150, 1000, 30, 'SWORDS DANCE', 'RETURN');");
			res = statement.executeUpdate("INSERT INTO POKEMON VALUES(19, 'LAPRAS', 'WATER', 'ICE', 100, 150, 800, 120, 'SWORDS DANCE', 'RETURN');");
